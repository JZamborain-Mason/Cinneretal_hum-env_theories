...
#NOTE:Please add your working directory (i.e., location where data is stored)
 setwd("c:/Users/jzamb/Dropbox/PhD/Research Worker Josh 2018/Distal drivers/R") 
...
#reviews test individual theories separately (including in model)
...
#note some pareto-k values are too high (done for first analyses)
...
#done for all combined analyses
...
#take out all pareto-k values that are influential for each model and re-run model selection
 ...
 full_tb_grav_nva_loglik_extracted<- full_tb_grav_nva_loglik[,,-highpareto_tb]
 ...
 full_tb_grav_nva_inter_loglik_extracted<- full_tb_grav_nva_inter_loglik[,,-highpareto_tb]
 ...
 full_tb_ttpop_nva_loglik_extracted=full_tb_ttpop_nva_loglik[,,-highpareto_tb]
 ...
 full_tb_ttpop_nva_intertt_loglik_extracted<-full_tb_ttpop_nva_intertt_loglik[,,-highpareto_tb]
 ...
 full_tb_ttpop_nva_interpop_loglik_extracted<- full_tb_ttpop_nva_interpop_loglik[,,-highpareto_tb]
 ...
 full_tb_ttpop_nva_interttpop_loglik_extracted<- full_tb_ttpop_nva_interttpop_loglik[,,-highpareto_tb]
 ...
 rownames2<-ifelse(rownames=="model1","NullModel_tb",ifelse(rownames=="model2","FullModel_grav_tb",ifelse(rownames=="model3","FullModel_grav_hdi2_tb",ifelse(rownames=="model4","FullModel_ttpop_tb",ifelse(rownames=="model5","FullModel_ttpop_hdi2_tb",ifelse(rownames=="model6","FullModel_grav_inter_tb",ifelse(rownames=="model7","FullModel_ttpop_interpop_tb",ifelse(rownames=="model8","FullModel_ttpop_intertt_tb",ifelse(rownames=="model9","FullModel_ttpop_interttpop_tb",ifelse(rownames=="model10","FullModel_ttpop_interHDI2management",ifelse(rownames=="model11","Location theory",ifelse(rownames=="model12","Env Kutznets",ifelse(rownames=="model13","Malthus",ifelse(rownames=="model14","Institutions",NA))))))))))))))
 row.names(modelselection_tb3_extracted)<-rownames2
 #write.csv(modelselection_tb3_extracted,"modelselection_tb_allcombined.csv",row.names=F)
...
#.....trait diversity .....
 ...
 full_td_grav_nva_loglik_extracted<- full_td_grav_nva_loglik[,,-highpareto_td]
 ...
 full_td_grav_nva_inter_loglik_extracted<- full_td_grav_nva_inter_loglik[,,-highpareto_td]
 ...
 full_td_ttpop_nva_loglik_extracted=full_td_ttpop_nva_loglik[,,-highpareto_td]
 ...
 full_td_ttpop_nva_intertt_loglik_extracted<-full_td_ttpop_nva_intertt_loglik[,,-highpareto_td]
 ...
 full_td_ttpop_nva_interpop_loglik_extracted<- full_td_ttpop_nva_interpop_loglik[,,-highpareto_td]
 ...
 full_td_ttpop_nva_interttpop_loglik_extracted<- full_td_ttpop_nva_interttpop_loglik[,,-highpareto_td]
 ...
 #model comparison 
 comp_td3_extracted <- loo_compare(loo_nullnull_td_extracted , loo_full_td_grav_nva_extracted,loo_full_td_grav_hdi2_nva_extracted, loo_full_td_ttpop_nva_extracted,loo_full_td_ttpop_hdi2_nva_extracted,loo_full_td_grav_nva_inter_extracted,loo_full_td_ttpop_nva_interpop_extracted,loo_full_td_ttpop_nva_intertt_extracted,loo_full_td_ttpop_nva_interttpop_extracted, loo_full_td_ttpop_hdi2inter_nva_extracted,loo_onlytt_td_extracted , loo_ek_td_extracted,loo_malth_td_extracted, loo_inst_td_extracted )
 ...
 rownames2<-ifelse(rownames=="model1","NullModel_td",ifelse(rownames=="model2","FullModel_grav_td",ifelse(rownames=="model3","FullModel_grav_hdi2_td",ifelse(rownames=="model4","FullModel_ttpop_td",ifelse(rownames=="model5","FullModel_ttpop_hdi2_td",ifelse(rownames=="model6","FullModel_grav_inter_td",ifelse(rownames=="model7","FullModel_ttpop_interpop_td",ifelse(rownames=="model8","FullModel_ttpop_intertt_td",ifelse(rownames=="model9","FullModel_ttpop_interttpop_td",ifelse(rownames=="model10","FullModel_ttpop_interHDI2management",ifelse(rownames=="model11","Location theory",ifelse(rownames=="model12","Env Kutznets",ifelse(rownames=="model13","Malthus",ifelse(rownames=="model14","Institutions",NA))))))))))))))
 row.names(modelselection_td3_extracted)<-rownames2
 #write.csv(modelselection_td3_extracted,"modelselection_td_allcombined.csv",row.names=F)
...
#.....PAtoppredators .....
 ...
 full_PAtp_grav_nva_loglik_extracted<- full_PAtp_grav_nva_loglik[,,-highpareto_PAtp]
 ...
 full_PAtp_grav_nva_inter_loglik_extracted<- full_PAtp_grav_nva_inter_loglik[,,-highpareto_PAtp]
 ...
 full_PAtp_ttpop_nva_loglik_extracted=full_PAtp_ttpop_nva_loglik[,,-highpareto_PAtp]
 ...
 full_PAtp_ttpop_nva_intertt_loglik_extracted<-full_PAtp_ttpop_nva_intertt_loglik[,,-highpareto_PAtp]
 ...
 full_PAtp_ttpop_nva_interpop_loglik_extracted<- full_PAtp_ttpop_nva_interpop_loglik[,,-highpareto_PAtp]
 ...
 full_PAtp_ttpop_nva_interttpop_loglik_extracted<- full_PAtp_ttpop_nva_interttpop_loglik[,,-highpareto_PAtp]
 ...
 #model comparison 
 comp_PAtp3_extracted <- loo_compare(loo_nullnull_PAtp_extracted , loo_full_PAtp_grav_nva_extracted,loo_full_PAtp_grav_hdi2_nva_extracted, loo_full_PAtp_ttpop_nva_extracted,loo_full_PAtp_ttpop_hdi2_nva_extracted,loo_full_PAtp_grav_nva_inter_extracted,loo_full_PAtp_ttpop_nva_interpop_extracted,loo_full_PAtp_ttpop_nva_intertt_extracted,loo_full_PAtp_ttpop_nva_interttpop_extracted, loo_full_PAtp_ttpop_hdi2inter_nva_extracted,loo_onlytt_PAtp_extracted , loo_ek_PAtp_extracted,loo_malth_PAtp_extracted, loo_inst_PAtp_extracted )
...
stanDat_full_ps_grav <- list(res=nrow(reserve_data),b = reserve_data$Scraping_potential,ag=reserve_data$sMPAage, si=reserve_data$sNTZarea,
 ...
 full_ps_grav_nva_loglik_extracted<- full_ps_grav_nva_loglik[,,-highpareto_ps]
 ...
 full_ps_grav_nva_inter_loglik_extracted<- full_ps_grav_nva_inter_loglik[,,-highpareto_ps]
 ...
 full_ps_ttpop_nva_loglik_extracted=full_ps_ttpop_nva_loglik[,,-highpareto_ps]
 ...
 full_ps_ttpop_nva_intertt_loglik_extracted<-full_ps_ttpop_nva_intertt_loglik[,,-highpareto_ps]
 ...
 full_ps_ttpop_nva_interpop_loglik_extracted<- full_ps_ttpop_nva_interpop_loglik[,,-highpareto_ps]
 ...
 full_ps_ttpop_nva_interttpop_loglik_extracted<- full_ps_ttpop_nva_interttpop_loglik[,,-highpareto_ps]
 ...
 rownames2<-ifelse(rownames=="model1","NullModel_ps",ifelse(rownames=="model2","FullModel_grav_ps",ifelse(rownames=="model3","FullModel_grav_hdi2_ps",ifelse(rownames=="model4","FullModel_ttpop_ps",ifelse(rownames=="model5","FullModel_ttpop_hdi2_ps",ifelse(rownames=="model6","FullModel_grav_inter_ps",ifelse(rownames=="model7","FullModel_ttpop_interpop_ps",ifelse(rownames=="model8","FullModel_ttpop_intertt_ps",ifelse(rownames=="model9","FullModel_ttpop_interttpop_ps",ifelse(rownames=="model10","FullModel_ttpop_interHDI2management",ifelse(rownames=="model11","Location theory",ifelse(rownames=="model12","Env Kutznets",ifelse(rownames=="model13","Malthus",ifelse(rownames=="model14","Institutions",NA))))))))))))))
 row.names(modelselection_ps3_extracted)<-rownames2
 #write.csv(modelselection_ps3_extracted,"modelselection_ps_allcombined.csv",row.names=F)
...
#individual best-fit models
 ...
 #write.csv(modelselection_extracted,"modelselection_all_combined_extracted.csv")
...
#summed looics: best overall fit model
 ...
 row.names(summedlooic_extracted)<-c("NullModel","FullModel_grav","FullModel_grav_hdi2","FullModel_ttpop","FullModel_ttpop_hdi2","FullModel_grav_inter","FullModel_ttpop_intertt","FullModel_ttpop_interpop","FullModel_ttpop_interttpop","FullModel_ttpop_interhdimanagement","Only EK","Only tt","Only Malth","Only Inst")
 ...
 #write.csv(summedlooic_extracted[order(summedlooic_extracted$summed_looic),],"summedlooic_extracted_combined.csv")
...
#..... PA top predators .....
 ...
 interceptfig_PAtp<- ggplot(intercept_PAtp)+geom_density(aes(x=I_fished),fill="black",alpha=0.5)+geom_density(aes(x=I_reserves),fill="grey",alpha=0.5)+theme_classic()+xlab("log(cm2/min)")+ylab("Posterior density")+
...
################################################################################
 ...
 betas_ps<- rstan::extract(Fit_full_ps_ttpop_nva_interpop,pars=c("beta"))[[1]]
 betas_ps<- broom.mixed::tidyMCMC(coda::as.mcmc(betas_ps),estimate.method = "median",conf.int=T, conf.level=c(0.9),conf.method='quantile')
 betas_ps$variable<-c("Depth >10m", "Depth 0-4m", "Crest", "Flat", "Backreef/lagoon","Point count","Distance sampling","Sampling area","Reserve size","Reserve age","Atoll","Ocean productivity", "SST anomalies","Population growth","Market travel time","Nearest settlement travel time","Reef fish landings","Population size","HDI","Market population (reserves)","Restricted fishing", "Nearest settlement population (reserves)","Market population (fished)","Nearest settlement population (fished)")
 betas_ps$sign<- ifelse(betas_ps$conf.low<0 & betas_ps$conf.high <0, "negative",ifelse(betas_ps$conf.low>0 & betas_ps$conf.high>0, "positive", "no effect"))
 betas_ps$order<-c(1,2,3,4,5,9,10,11,12,13,6,7,8,18,24,23 ,17,16,15,20,14,19,21,22)
 betas_ps[order(betas_ps$order),]
 betas_ps$variable <- factor(betas_ps$variable, levels = betas_ps$variable[order(betas_ps$order)])
 ...
 windows()
 betasfig<-ggarrange(betasfig_td,betasfig_ps,nrow=1,ncol=2,widths=c(1,1.1),labels=c("a","b"))
 betasfig
...
#save.image(file='Cinneretal_hetheories_revised.RData')
load('Cinneretal_hetheories_revised.RData')
