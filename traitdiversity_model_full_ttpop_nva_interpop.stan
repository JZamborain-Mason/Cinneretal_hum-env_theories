...
//fished component
for (i in 1:fis){ 
  mu2[i] = intercept_fished_rc[prc2[i]]+beta[1]*dd2[i]+beta[2]*ds2[i]+beta[3]*rh_c2[i]+beta[4]*rh_f2[i]+beta[5]*rh_b2[i]+beta[6]*cm_pc2[i]+beta[7]*cm_ds[i]+beta[8]*sa2[i]+ beta[11]*at2[i]+ beta[12]*op2[i]+ beta[13]*cs2[i]+ beta[14]*pg2[i]+ beta[15]*ttNC2[i]+ beta[16]*ttNP2[i]+ beta[17]*rl2[i]+ beta[18]*ps2[i]+ beta[19]*hdi2[i]+ beta[20]*mr[i]+ beta[23]*popNC2[i]+ beta[24]*popNP2[i];
  }
}
model {
 //priors
